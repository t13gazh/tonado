...
Frühere Audit-Snapshots, die als Issue-Tracker dienten. Alle Findings sind mittlerweile adressiert — die Dateien bleiben als Projekt-Historie erhalten.

| Datei | Kontext |
|-------|---------|
| `AUDIT-2026-03-28.md` | Erstes Security+Arch-Audit vor der ersten Alpha. Alle Findings erledigt. |
